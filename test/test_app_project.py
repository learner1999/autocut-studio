...
class TestAppProject(unittest.TestCase):
    ...
    def test_project_from_subtitles_peels_detected_silence_from_speech_edges(self):
        ...
        self.assertAlmostEqual(project.segments[0].start, 0)
        self.assertAlmostEqual(project.segments[0].end, 0.95)
        self.assertAlmostEqual(project.segments[1].start, 0.95)
        self.assertAlmostEqual(project.segments[1].end, 6.35)
        self.assertAlmostEqual(project.segments[2].start, 6.35)
